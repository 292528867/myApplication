...
import com.example.yk.myapplication.util.ZoomBitmap;
...
public class UploadImageTest extends Activity implements View.OnClickListener {

    // 服务器地址
    private static final String HOST = "http://127.0.0.1:8080/viewSpot/test";
    // 显示图片
